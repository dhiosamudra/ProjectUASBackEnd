...
<div class="jumbotron">
    <div class="container">
        ...
        <p class="lead">Mari berbelanja di Tya Store, disini kami menyediakan semua kebutuhan elektronik kalian dengan harga yang lebih murah</p>
        <hr class="my-4">
        ...
        <div class="col-md-3">
            <div class="card mt-3">
                <a href="{{ route('produk.detail', ['slug' => $prd->slug_prd]) }}">
                    <img src="{{ asset('img/produk/'.$prd->gbr_prd) }}" class="card-img-top" alt="{{ $prd->nm_prd }}">
                </a>
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <small class="text-right text-primary my-auto">Rp. {{ number_format($prd->hrg_prd) }}</small>
                    </div>
                </div>
            </div>
        </div>
